...
def write_csv(filename, headers, rows):
    try:
        ...
        logging.info("Results written to %s successfully.", filename)
    except Exception as e:
        logging.error("Error writing results to %s: %s", filename, e)
        raise
...
def main():
    ...
    try:
        ...
        write_csv("output1.csv", headers1, results1)
        ...
        write_csv("output2.csv", headers2, results2)
