...
def save_to_csv(filename, colnames, results):
    try:
        ...
        logging.error("Error saving results to %s: %s", filename, e)
...
def main():
    ...
    if results1 is not None:
        save_to_csv("output1.csv", colnames1, results1)
    else:
    ...
    if results2 is not None:
        save_to_csv("output2.csv", colnames2, results2)
    else:
